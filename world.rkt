...
(define game-canvas%
  (class canvas%
    ...
    ;; FUNCTION:    on-char
    ;;
    ;; DESCRIPTION: The keyboard listener. I case of key-codes it sets the corresponding
    ;;              value in the hash table to #t. In case of release-code of the button
    ;;              it sets the value to #f.
    ;;
    ;; INPUT:       key-events from keyboard.
    ;;
    ;; OUTPUT:      None.
    ...
    ;; FUNCTION: all-dead
    ;;
    ;; DESCRIPTION: Function that runs when all players are stopped to close down the game window and
...
(define all-dead
  (lambda ()
    ...
    ;; FUNCTION: sum-up-score
    ;;
    ;; DESCRIPTION: Function thats adds up score to the accumulated-score field in player class aswell as changing
